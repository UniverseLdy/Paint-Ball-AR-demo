...
public class MobileShooter : MonoBehaviour {
    ...
    public void Activate()
    {
        ...
        CameraGyro.ControlledObject = phoneCube;
    ...
    public void ShootBall(Vector3 velocity)
    {
        ...
        var ball = PhotonNetwork.Instantiate("ball", this.phoneCube.transform.position, this.phoneCube.transform.rotation, 0) as GameObject;
        ball.GetComponent<PhotonView>().RPC("RPCInitialize", PhotonTargets.All, new object[]{velocity, color_v});
        //ball.GetComponent<BallBehavior>().RPCInitialize(velocity, color_v);
