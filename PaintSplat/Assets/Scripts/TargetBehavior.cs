    ...
    **/
    void LateUpdate() {
        ...
        else
        {
            ...
            {
                float dotProduct = Vector3.Dot(CameraGyro.ControlledObject.transform.forward, CameraProxy.transform.forward);
                if (dotProduct != 0)
                {
                    CameraProxy.transform.rotation = CameraGyro.ControlledObject.transform.rotation;
                }
            }
        }
    }
